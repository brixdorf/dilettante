...
To explain with a recent event, Anthropic's chief product officer was a board member of Figma till the day news broke out that Anthropic's next model would ship design tools. Anthropic launched Claude Design 3 days later, a product which is a direct competitor to Figma. As [David Sacks pointed out](https://x.com/DavidSacks/status/2072673187666813226), Anthropic reportedly "blindsided" Figma with the launch. Can you understand how ridiculous this is?
...
***Update (Aug 4, 2026):*** a claim in the Figma/Claude Design section was revised for accuracy. The earlier version overstated what's been reported.
